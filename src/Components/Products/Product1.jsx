...
const Product1 = ()=>{
    ...
    return(
        ...
        <Slider className="ml-[40px] max-xs:ml-[60px]   mr-[40px] max-xs:mr-[30px]  mb-20" {...settings}> 
         {
             CoffeeData.map((data , id)=>{
                 return(
                     
                     <div key={id} className="  border-lg  w-[280px]   ml-8 max-xs:ml-2  scroll-smooth">
                 ...
                 <div className=" ">
                       ...
                       <div>
                           <button className="bg-yellow-600 w-[15vh] h-8 mt-2" onClick={()=>addProduct(data , id)}>Add to cart</button>
                       </div>
                    </div>    
                 </div>    
                )
